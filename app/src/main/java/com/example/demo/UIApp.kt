...
class UIApp : Application() {
    ...
    val packageInfo: PackageInfo get() = packageManager.getPackageInfo(packageName, 0)

    @Suppress("DEPRECATION")
    val versionCode get() = packageInfo.versionCode
    val versionName get() = packageInfo.versionName
    val isDebuggable get() = (applicationInfo.flags and ApplicationInfo.FLAG_DEBUGGABLE) != 0
