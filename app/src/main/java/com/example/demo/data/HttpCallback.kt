...
interface HttpCallback<T> : Callback {
    ...
    override fun onResponse(call: Call, response: Response) {
        ...
        val actualTypeArguments = (genericInterface as ParameterizedType).actualTypeArguments[0]
        val responseType = ParameterizedTypeImpl(HttpResponse::class.java, actualTypeArguments)
        val gson = Gson()
